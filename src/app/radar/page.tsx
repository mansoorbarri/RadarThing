          ...
          >
            ...
            >
              ...
              {isProUser ? (
                ...
                <div
                  className={`flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 ${isMobile ? "px-2 py-1" : "px-3 py-1.5"}`}
                >
                  <span
                    className={`text-white/60 ${isMobile ? "text-[9px]" : "text-[10px]"}`}
                  >
                    Charts
                  </span>

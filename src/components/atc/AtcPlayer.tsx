  ...
  if (onlineAtc) {
    return (
      <div className="animate-scale-in fixed bottom-24 left-1/2 z-[10013] w-[320px] -translate-x-1/2 rounded-2xl border border-green-500/20 bg-black/90 p-4 backdrop-blur-xl">
        ...
        {/* Actions */}
        <a
          href={onlineAtc.discordInvite}
          target="_blank"
          rel="noopener noreferrer"
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-green-500/20 py-3 text-sm font-medium text-green-400 transition-colors hover:bg-green-500/30"
        >
        ...
        <p className="mt-3 text-center text-[10px] text-slate-500">
          Opens Discord voice channel in a new tab
        </p>
      </div>
    );
  }
